...
class AlarmController extends BaseController {
	...
	public function index(){
        ...
        $breadcrumbs = array('Home' => 'alarm', 'Manage Alarm' => 'alarm');	
                                
		return View::make('alarm.index',compact('sort', 'sort_order'))->with('breadcrumbs',$breadcrumbs)->with('alarms', $alarm)->with('alarm_codes', $alarm_codes); 	
	}
