...
class AdminUserNormalController extends BaseController {
	...
	public function index(){
    	...
    	$breadcrumbs = array('User' => 'admin/users_normal', 'Manage User' => 'admin/users_normal');

		return View::make('admin.users_normal.index')->with('breadcrumbs',$breadcrumbs)->with("sort", $sort)->with("sort_order",$sort_order)->with('users', $users);
	}
	...
	public function create(){
		...
		$breadcrumbs = array('User' => 'admin/users_normal', 'Add User' => 'admin/users_normal/create');

		return View::make('admin.users_normal.create', $data)->with('breadcrumbs',$breadcrumbs)->with('groups',$groups)->with('brands',$brands)->with('channels',$channels)//->with('stations',$stations)
	...
	public function store(){
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('admin/users_normal/create')->withErrors($validator)->withInput(Input::except('password'));
		} else {
			...
			return Redirect::to('admin/users_normal/'.$user->id);
		}
	}
	...
	public function show($id){
		...
		if(!empty($user)) {
			...
			$breadcrumbs = array('User' => 'admin/users_normal', 'View User' => 'admin/users_normal');	

			// show the view and pass the nerd to it
			return View::make('admin.users_normal.show')->with('breadcrumbs',$breadcrumbs)->with('user', $user);
		}else{
			return Redirect::to('admin/users_normal');
		}
	}
	...
	public function edit($id){
		...
		$breadcrumbs = array('User' => 'admin/users_normal', 'Edit User' => 'admin/users_normal');			

		// show the edit form and pass the nerd
		return View::make('admin.users_normal.edit', $data)->with('breadcrumbs',$breadcrumbs)->with('user', $user)->with('user_groups', $user_groups)->with('groups',$groups)
	...
	public function update($id){
       ...
       // echo "<pre>".print_r($channels,true)."</pre>"; exit();
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('admin/users_normal/' . $id . '/edit')->withErrors($validator)->withInput(Input::except('password'));
		} else {
			// store
			$user 				= User::find($id);
			$user->name       	= Input::get('name');
