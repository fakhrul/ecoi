...
class AdminUserAdminController extends BaseController {
	...
	public function index(){
    	...
    	$breadcrumbs = array('User' => 'admin/users_admin', 'Manage User' => 'admin/users_admin');

		return View::make('admin.users_admin.index')->with('breadcrumbs',$breadcrumbs)->with("sort", $sort)->with("sort_order",$sort_order)->with('users', $users);
	}
	...
	public function create(){
		...
		$breadcrumbs = array('User' => 'admin/users_admin', 'Add User' => 'admin/users_admin/create');

		return View::make('admin.users_admin.create', $data)->with('breadcrumbs',$breadcrumbs)->with('groups',$groups)->with('brands',$brands)->with('channels',$channels)//->with('stations',$stations)
	...
	public function store(){
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('admin/users_admin/create')->withErrors($validator)->withInput(Input::except('password'));
		} else {
			...
			return Redirect::to('admin/users_admin/'.$user->id);
		}
	}
	...
	public function show($id){
		...
		if(!empty($user)) {
			...
			$breadcrumbs = array('User' => 'admin/users_admin', 'View User' => 'admin/users_admin');	

			// show the view and pass the nerd to it
			return View::make('admin.users_admin.show')->with('breadcrumbs',$breadcrumbs)->with('user', $user);
		}else{
			return Redirect::to('admin/users_admin');
		}
	}
	...
	public function edit($id){
		...
		$breadcrumbs = array('User' => 'admin/users_admin', 'Edit User' => 'admin/users_admin');			

		// show the edit form and pass the nerd
		return View::make('admin.users_admin.edit', $data)->with('breadcrumbs',$breadcrumbs)->with('user', $user)->with('user_groups', $user_groups)->with('groups',$groups)
	...
	public function update($id){
       ...
       // echo "<pre>".print_r($channels,true)."</pre>"; exit();
		...
		// process the login
		if ($validator->fails()) {
			return Redirect::to('admin/users_admin/' . $id . '/edit')->withErrors($validator)->withInput(Input::except('password'));
		} else {
			// store
			$user 				= User::find($id);
			$user->name       	= Input::get('name');
