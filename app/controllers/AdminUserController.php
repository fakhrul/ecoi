...
class AdminUserController extends BaseController {
	...
	public function index(){
    	...
    	$breadcrumbs = array('User' => 'admin/users', 'Manage User' => 'admin/users');

		return View::make('admin.users.index')->with('breadcrumbs',$breadcrumbs)->with("sort", $sort)->with("sort_order",$sort_order)->with('users', $users);
	}
	...
	public function create(){
        ...
        $channels = ['' => '- Select A Channel -'] + $channels;        
		...
		$breadcrumbs = array('User' => 'admin/users', 'Add User' => 'admin/users/create');

		return View::make('admin.users.create', $data)->with('breadcrumbs',$breadcrumbs)->with('groups',$groups)->with('brands',$brands)->with('channels',$channels)//->with('stations',$stations)
	...
	public function show($id){
		...
		if(!empty($user)) {
			...
			$breadcrumbs = array('User' => 'admin/users', 'View User' => 'admin/users');	

			// show the view and pass the nerd to it
			return View::make('admin.users.show')->with('breadcrumbs',$breadcrumbs)->with('user', $user);
		}else{
	...
	public function edit($id){
		...
		$breadcrumbs = array('User' => 'admin/users', 'Edit User' => 'admin/users');			

		// show the edit form and pass the nerd
		return View::make('admin.users.edit', $data)->with('breadcrumbs',$breadcrumbs)->with('user', $user)->with('user_groups', $user_groups)->with('groups',$groups)
