...
@endif
	...
	<div class="clearfix">
     ...
     @if (allowed('admin.summary.create'))		  	
    ...
    {{ Form::open([ "id"=>"form_export", "name"=>"form_export", "url" => "admin/summary/export"]) }}
			...
			<table class="table table-hover table-striped table-bordered">
				...
				@foreach($summary as $key => $value)
					<tr>
						...
						<td>
            				@if (false and allowed('admin.summary.destroy'))
            				...
            				@if (allowed('admin.summary.show'))
            				<!-- show the nerd (uses the show method found at GET /nerds/{id} -->
                            <a href="{{ URL::to('admin/summary/' . $value->id) }}">View</a>
            				@endif
            				<!-- / -->
            				@if (allowed('admin.summary.edit'))
            				<!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
                            <!--<a href="{{ URL::to('admin/summary/' . $value->id . '/edit') }}">Edit</a>-->
