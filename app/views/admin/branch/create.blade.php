...
<div class="panel panel-default">
		...
		<div class="panel-body">
			{{ Form::open(array('url' => 'admin/branch', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'form_branch')) }}
			<div class="form-group">
				<label for="channel_id" class="col-sm-2 control-label">Channel <span class="text-danger">*</span></label>
				<div class="col-sm-5">		
