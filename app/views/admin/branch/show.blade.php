	...
	<div class="clearfix">
		<div class="visible-md-block visible-lg-block">
			<a id="back_to_branch" type="button" class="btn btn-primary" href="{{ URL::to('admin/branch') }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>
		  	<a type="button" class="btn btn-primary" href="{{ URL::to('admin/branch/' . $list->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Edit</a>
		...
		<div class="visible-xs-block visible-sm-block dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li><a href="{{ URL::to('admin/branch/' . $list->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a></li>
			</ul>
		</div>
	</div>
