...
<div class="clearfix">
	<div class="visible-md-block visible-lg-block">
		<a id="back_to_branch" type="button" class="btn btn-primary" href="{{ URL::to('admin/branch') }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>
	...
	<div class="visible-xs-block visible-sm-block dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			<li><a id="back_to_branch" href="{{ URL::to('admin/branch') }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
		</ul>
	</div>
</div>
<!-- action button end -->
...
<div class="panel panel-default">
		...
		<div class="panel-body">
			{{ Form::open(array('route' => array('admin.branch.update', $list->id), 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'form_branch', 'method' => 'PUT')) }}
			<div class="form-group">
				<label for="type" class="col-sm-2 control-label">Channel</label>
				<div class="col-sm-5">		
					<input type="text" class="form-control" value="{{$list->channel->name}}" readonly>
				</div>
			</div>
