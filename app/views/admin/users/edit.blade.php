...
@endif
	<div class="clearfix">
		<div class="visible-md-block visible-lg-block">
			<a id="back_to_user" type="button" class="btn btn-primary" href="{{ URL::to('admin/users/' . $user->id) }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>
		...
		<div class="visible-xs-block visible-sm-block dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				<li><a id="back_to_user" href="{{ URL::to('admin/users/' . $user->id) }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="panel panel-default">
		...
		{{ Form::model($user, array('route' => array('admin.users.update', $user->id), 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'form_user')) }}
