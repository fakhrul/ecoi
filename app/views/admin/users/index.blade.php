				...
				<table class="table table-hover table-striped table-bordered">
					<thead>
						<tr>
							...
							<th class="{{($sort=='users.channel_id')? (($sort_order=='desc')? 'sort_desc' : 'sort_asc') : 'sort' }} pointer" value="users.channel_id">Channel</th>	
					...
					@foreach($users as $key => $value)
						<tr>
        					...
        					@if (false and allowed('admin.users.destroy'))
        					...
        					@if (allowed('admin.users.show'))
        					<!-- show the nerd (uses the show method found at GET /nerds/{id} -->
        					<a href="{{ URL::to('admin/users/' . $value->id) }}">View</a>
        					@endif
        					|
        					@if (allowed('admin.users.edit'))
        					<!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
        					<a href="{{ URL::to('admin/users/' . $value->id . '/edit') }}">Edit</a>
        					@endif
