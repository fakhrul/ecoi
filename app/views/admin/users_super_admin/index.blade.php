...
<h3>Super Admin List</h3>
@stop
<?
define("PAGETITLE", " | Super Admin List");
...
@endif
	...
	<div class="clearfix">
		<div class="visible-md-block visible-lg-block">
		  	...
		  	<a type="button" class="btn btn-primary" href="users_super_admin/create"><span class="glyphicon glyphicon-plus"></span>&nbsp;Add</a>
		...
		<div class="visible-xs-block visible-sm-block dropdown">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<li><a href="users_super_admin/create"><span class="glyphicon glyphicon-plus"></span> Add</a></li>
			</ul>
		</div>
	</div>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					@foreach($users as $key => $value)
						<tr>
        					...
        					@if (false and allowed('admin.users_super_admin.destroy'))
        					...
        					@if (allowed('admin.users_super_admin.show'))
        					<!-- show the nerd (uses the show method found at GET /nerds/{id} -->
        					<a href="{{ URL::to('admin/users_super_admin/' . $value->id) }}">View</a>
        					@endif
        					|
        					@if (allowed('admin.users_super_admin.edit'))
        					<!-- edit this nerd (uses the edit method found at GET /nerds/{id}/edit -->
        					<a href="{{ URL::to('admin/users_super_admin/' . $value->id . '/edit') }}">Edit</a>
        					@endif
