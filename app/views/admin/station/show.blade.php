...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        var isMobileDevice  = isMobileDevices(); //alert(isMobileDevice);
        if(isMobileDevice){
...
<div ng-app="csgApp" ng-controller="pukController">
	...
	<div class="clearfix">
        ...
        @if (!$station->deleted_at)		
	  		<a type="button" class="btn btn-primary" href="{{ URL::to('admin/station/' . $station->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Edit</a>
		@endif
		...
		<div class="visible-xs-block visible-sm-block dropdown">		
				...
				<ul class="dropdown-menu" role="menu">
					<li><a id="back_to_station2" href="{{ URL::to('admin/station') }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
                @if (!$station->deleted_at)	
					<li><a href="{{ URL::to('admin/station/' . $station->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a></li>	
				@endif
