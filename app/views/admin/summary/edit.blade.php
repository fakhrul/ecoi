	...
	<div class="panel-body">
		...
		<div class="form-group">
				...
				<!-- <div class="col-sm-3">
				 ...
				 <div class="col-sm-3">
					<div class="input-group">
					{{ Form::select('sam_M', array('0' => '1', '1' => '5', '2' => '15', '3' => '30', '4' => '60'),  Input::old('sam_M'), array('class' => 'form-control')) }}
			...
			<div class="form-group">
				...
				<!-- <div class="col-sm-3">
				 ...
				 <div class="col-sm-3">
					<div class="input-group">
					{{ Form::select('transfer_M', array('0' => '1', '1' => '5', '2' => '15', '3' => '30', '4' => '60'), Input::old('transfer_M'), array('class' => 'form-control')) }}
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form-group">
			...
			<div class="col-sm-3 form-inline">
				User: {{ Form::text('server1_user', Input::old('server1_user'), array('class' => 'form-control')) }}
			</div>
			<div class="col-sm-3 form-inline">
				Pass: {{ Form::text('server1_pass', Input::old('server1_pass'), array('class' => 'form-control')) }}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3 form-inline">
				User: {{ Form::text('server2_user', Input::old('server2_user'), array('class' => 'form-control')) }}
			</div>
			<div class="col-sm-3 form-inline">
				Pass: {{ Form::text('server2_pass', Input::old('server2_pass'), array('class' => 'form-control')) }}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3 form-inline">
				User: {{ Form::text('server3_user', Input::old('server3_user'), array('class' => 'form-control')) }}
			</div>
			<div class="col-sm-3 form-inline">
				Pass: {{ Form::text('server3_pass', Input::old('server3_pass'), array('class' => 'form-control')) }}
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3 form-inline">
				User: {{ Form::text('server4_user', Input::old('server4_user'), array('class' => 'form-control')) }}
			</div>
			<div class="col-sm-3 form-inline">
				Pass: {{ Form::text('server4_pass', Input::old('server4_pass'), array('class' => 'form-control')) }}
			</div>
		</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form-group">
			{{ Form::label('FTP_1', 'Server 1', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3 form-inline">
				{{ Form::text('server1_folder', Input::old('server1_folder'), array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="form-group">
			{{ Form::label('FTP_2', 'Server 2', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3 form-inline">
				{{ Form::text('server2_folder', Input::old('server2_folder'), array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="form-group">
			{{ Form::label('FTP_3', 'Server 3', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3 form-inline">
				{{ Form::text('server3_folder', Input::old('server3_folder'), array('class' => 'form-control')) }}
			</div>
		</div>
		<div class="form-group">
			{{ Form::label('FTP_4', 'Server 4', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3 form-inline">
				{{ Form::text('server4_folder', Input::old('server4_folder'), array('class' => 'form-control')) }}
			</div>
		</div>
	</div>
</div>
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form-group">
			{{ Form::label('Server_1', 'Phone', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3 form-inline">
				{{ Form::checkbox('sms_server_enabled',null,$summary->sms_server_enabled, array('id'=>'sms_server_enabled')) }}
				IP: {{ Form::text('sms_server_no', Input::old('sms_server_no'), array('class' => 'form-control')) }}
			</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<div class="form-group">
			{{ Form::label('as1_datum', 'Datum', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3">
				<div class="input-group">
					{{ Form::text('as1_datum',  $sensor_setting->as1_datum, array('class' => 'form-control')) }}
					<span class="input-group-addon">m</span>
				</div>
			</div>
			{{ Form::label('as1_min', 'Minimum', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3">
				<div class="input-group">
					{{ Form::text('as1_min',  $sensor_setting->as1_min, array('class' => 'form-control')) }}
					<span class="input-group-addon">m</span>
				</div>
			</div>
		</div>
		<div class="form-group">
			{{ Form::label('as1_max', 'Maximum', array('class' => 'col-sm-2 control-label')) }}
			<div class="col-sm-3">
				<div class="input-group">
					{{ Form::text('as1_max',  $sensor_setting->as1_max, array('class' => 'form-control')) }}
					<span class="input-group-addon">m</span>
				</div>
			</div>
			<div class="col-sm-3">
