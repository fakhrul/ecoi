...
<div class="form-group">
	...
	<div class="col-sm-10">		
		{{ Form::text('channel_id', $user->channel->name, array('class' => 'form-control', 'readonly')) }}
	</div>	
</div>
...
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
		 <a type="button" class="btn btn-primary" href="{{ URL::to('users/' . $user->id) }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>
