...
@endif
	<div class="clearfix">
        ...
        {{ Form::open(array('route' => array('summary.destroy', $summary->id), 'method' => 'delete')) }}
            <a id="restore_summary" type="button" class="btn btn-primary" href="{{ URL::to('summary') }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a> 		
        @if (!$summary->deleted_at and allowed('summary.edit'))		
		  	<!--<a type="button" class="btn btn-primary" href="{{ URL::to('summary/' . $summary->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Edit</a>
		  	<button id="delete_summary" type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span>&nbsp;Delete</button>-->	
        @endif
        @if ($summary->deleted_at and allowed('summary.destroy'))			  	
		  	<!--<a id="restore_summary" type="button" class="btn btn-primary" href="{{ URL::to('summary/restore?id=' . $summary->id) }}"><span class="glyphicon glyphicon-repeat"></span>&nbsp;Restore</a>-->		  
        @endif	
        {{ Form::close() }}		  	
        ...
        {{ Form::open(array('route' => array('summary.destroy', $summary->id), 'method' => 'delete')) }}			
			...
			<ul class="dropdown-menu" role="menu">
				<li><a id="restore_summary" href="{{ URL::to('summary') }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
            @if (!$summary->deleted_at and allowed('summary.edit'))	
				<!--<li><a href="{{ URL::to('summary/' . $summary->id) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a></li>									
            ...
            @endif			
            @if ($summary->deleted_at and allowed('summary.destroy'))					
				<!--<li><a id="restore_summary" href="{{ URL::to('summary/restore?id=' . $summary->id) }}"><span class="glyphicon glyphicon-repeat"></span> Restore</a></li>-->
            @endif					
			</ul>
        {{ Form::close() }}				
		</div>
