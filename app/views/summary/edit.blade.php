...
<div class="clearfix">
	<div class="visible-md-block visible-lg-block">
		<a id="back_to_summary" type="button" class="btn btn-primary" href="{{ URL::to('summary') }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>
	...
	<div class="visible-xs-block visible-sm-block dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			<li><a id="back_to_summary" href="{{ URL::to('summary') }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
		</ul>
	</div>
</div>
<!-- action button end -->

{{ Form::model($summary, array('route' => array('summary.update', $summary->idrut_config), 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'form_summary')) }}
