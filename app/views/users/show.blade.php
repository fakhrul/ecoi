	...
	<div class="clearfix">
		<div class="visible-md-block visible-lg-block">
			{{ Form::open(array('route' => array('users.destroy', $user->id), 'method' => 'delete')) }}
		 		<a id="back_to_user" type="button" class="btn btn-primary" href="{{ URL::to('users') }}"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a>			
			@if (!$user->deleted_at)		
		  		...
		  		@endif
			@endif
			@if ($user->deleted_at and allowed('users.restore'))			  	
		  		<a id="restore_user" type="button" class="btn btn-primary" href="{{ URL::to('users/restore?id=' . $user->id) }}"><span class="glyphicon glyphicon-repeat"></span>&nbsp;Restore</a>		  
			@endif	
			{{ Form::close() }}		  	
		...
		<div class="visible-xs-block visible-sm-block dropdown">
			{{ Form::open(array('route' => array('users.destroy', $user->id), 'method' => 'delete')) }}			
				...
				<ul class="dropdown-menu" role="menu">
					<li><a id="back_to_user" href="{{ URL::to('users') }}"><span class="glyphicon glyphicon-arrow-left"></span> Back</a></li>
				@if (!$user->deleted_at)	
				...
				@endif			
				@if ($user->deleted_at)					
					<li><a id="restore_user" href="{{ URL::to('users/restore?id=' . $user->id) }}"><span class="glyphicon glyphicon-repeat"></span> Restore</a></li>	
				@endif					
				</ul>
			{{ Form::close() }}				
		</div>
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<p class="form-control-static">{{$user->deleted_at ? $user->deleted_at . ' (' .$user->deleteUser->name .')' : '-'}}</p>
					</div>
				</div>
				<div class="form-group">
