...
@endif
	...
	<div class="clearfix">
        ...
        {{ Form::open(array('route' => array('summary.destroy', $summary->idrut_config), 'method' => 'delete')) }} 		
        @if (!$summary->deleted_at and allowed('summary.edit'))		
		  	<a type="button" class="btn btn-primary" href="{{ URL::to('summary/' . $summary->idrut_config) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Edit</a>	
        @endif	
        {{ Form::close() }}		  	
        ...
        {{ Form::open(array('route' => array('summary.destroy', $summary->idrut_config), 'method' => 'delete')) }}			
            ...
            @if (!$summary->deleted_at and allowed('summary.edit'))	
				<li><a href="{{ URL::to('summary/' . $summary->idrut_config) .'/edit' }}"><span class="glyphicon glyphicon-pencil"></span> Edit</a></li>
            @endif					
			</ul>
        {{ Form::close() }}				
		</div>
