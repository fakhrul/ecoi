...
{{ Form::open(array('url' => 'channels', 'class' => 'form-horizontal', 'role' => 'form')) }}
...
<div class="form-group">
	...
	<div class="col-sm-2">
		<input type="date" class="form-control" name="effective_date" id="effective_date" placeholder="yyyy-mm-dd">
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-3">		
		{{ Form::select('state', array('' => 'Select Bank', 'Affin Bank' => 'Affin Bank', 'Alliance Bank' => 'Alliance Bank', 'AmBank' => 'AmBank', 'CIMB Bank' => 'CIMB Bank', 'Hong Leong Bank' => 'Hong Leong Bank', 'Maybank' => 'Maybank', 'Public Bank' => 'Public Bank', 'RHB Bank' => 'RHB Bank'), Input::old('bank_name'), array('class' => 'form-control')) }}
	</div>
</div>
