...
Route::group(['prefix' => 'admin'], function() {
	...
	Route::resource('branch', 'AdminBranchController'); // added by liyin 2015-07-27
	...
	//Route::get('transferownership', array('as' => 'admin.transferownership.index', 'uses' => 'AdminTransferOwnershipController@index'));
	//Route::get('transferownership/create', 'AdminTransferOwnershipController@create');
	//Route::get('transferownership/create/', array('as' => 'admin.transferownership.create', 'uses' => 'AdminTransferOwnershipController@create'));
	//Route::post('transferownership/store/{msisdn}', 'AdminTransferOwnershipController@store');
	//Route::post('transferownership/store/{msisdn}', array('as' => 'admin.transferownership.store', 'uses' => 'AdminTransferOwnershipController@store'));
	//Route::get('transferownership/{id}', 'AdminTransferOwnershipController@show');
	//Route::get('transferownership/{id}', array('as' => 'admin.transferownership.show', 'uses' => 'AdminTransferOwnershipController@show'));
	...
	Route::post("easysim_subscriber/export", array('as' => 'admin.easysim_subscriber.export', 'uses' => 'AdminEasySimSubscriberController@export'));
	Route::post("easysim_subscriber/getBlockStatus", array('as' => 'admin.easysim_subscriber.getBlockStatus', 'uses' => 'AdminEasySimSubscriberAPIController@getBlockStatus'));
	Route::post("easysim_subscriber/editBlockStatus", array('as' => 'admin.easysim_subscriber.editBlockStatus', 'uses' => 'AdminEasySimSubscriberController@editBlockStatus'));
	Route::post("easysim_subscriber/getInfo", array('as' => 'admin.easysim_subscriber.getInfo', 'uses' => 'AdminEasySimSubscriberAPIController@getInfo'));
	Route::resource('easysim_subscriber', 'AdminEasySimSubscriberController');
	Route::resource('easysim_billing', 'AdminEasySimBillingController');
});
...
Route::resource('easysim_registration', 'EasySimRegistrationController');
Route::get('easysim/validate_registration', 'EasySimRegistrationController@validate_unisim_registration');
Route::resource('easysim_reload', 'EasySimReloadController');

Route::resource('portin', 'PortInController');

Route::get('prepaidaccount/{id}/puk', array('as' => 'prepaidaccount.puk', 'uses' => 'PrepaidAccountController@getPUK'));
Route::get('prepaidaccount/{id}/bill', array('as' => 'prepaidaccount.bill', 'uses' => 'PrepaidAccountController@getBill'));
Route::get('prepaidaccount/{id}/cust', array('as' => 'prepaidaccount.cust', 'uses' => 'PrepaidAccountController@getCust'));
Route::get('prepaidaccount/{id}/bar', array('as' => 'prepaidaccount.bar', 'uses' => 'PrepaidAccountController@getBar'));
Route::get('prepaidaccount/{id}/unbar', array('as' => 'prepaidaccount.unbar', 'uses' => 'PrepaidAccountController@getUnbar'));

// Naz code 2015-03-23
Route::resource('prepaidaccount', 'PrepaidAccountController');
//Route::get("prepaidaccount/getBill2/{id}", "PrepaidAccountController@getBill2");
Route::get('prepaidaccount/getBill2/{id}', array('as' => 'prepaidaccount.getBill2', 'uses' => 'PrepaidAccountController@getBill2'));
//Route::get("prepaidaccount/barUnbar/{id}", "PrepaidAccountController@barUnbar");
Route::get('prepaidaccount/barUnbar/{id}', array('as' => 'prepaidaccount.barUnbar', 'uses' => 'PrepaidAccountController@barUnbar'));
//Route::get("prepaidaccount/retrievereloadhistory/{id}", "PrepaidAccountController@getReloadHistory");
Route::get('prepaidaccount/retrievereloadhistory/{id}', array('as' => 'prepaidaccount.retrievereloadhistory', 'uses' => 'PrepaidAccountController@getReloadHistory'));
//Route::get("prepaidaccount/retrieveFreebies/{id}", "PrepaidAccountController@getFreebies");
Route::get('prepaidaccount/retrieveFreebies/{id}', array('as' => 'prepaidaccount.retrieveFreebies', 'uses' => 'PrepaidAccountController@getFreebies'));
//Route::get("prepaidaccount/retrieveFnF/{id}", "PrepaidAccountController@getFnF");
Route::get('prepaidaccount/retrieveFnF/{id}', array('as' => 'prepaidaccount.retrieveFnF', 'uses' => 'PrepaidAccountController@getFnF'));
//Route::get("prepaidaccount/retrieveSubsriber/{id}", "PrepaidAccountController@getSubscription");
Route::get('prepaidaccount/retrieveSubsriber/{id}', array('as' => 'prepaidaccount.retrieveSubsriber', 'uses' => 'PrepaidAccountController@getSubscription'));
//Route::get("prepaidaccount/retrieveAccBalance/{id}", "PrepaidAccountController@getAccbalance");
Route::get('prepaidaccount/retrieveAccBalance/{id}', array('as' => 'prepaidaccount.retrieveAccBalance', 'uses' => 'PrepaidAccountController@getAccbalance'));
//Route::get("prepaidaccount/adjustAcc/{id}", "PrepaidAccountController@adjustAcc");
Route::get('prepaidaccount/adjustAcc/{id}', array('as' => 'prepaidaccount.adjustAcc', 'uses' => 'PrepaidAccountController@adjustAcc'));
//naz 2015-06-01
...
Route::resource('admin/msisdnstatus', 'AdminMsisdnStatusController');
Route::resource('msisdnstatus', 'AdminMsisdnStatusController');
...
Route::get('transferpin/preview', function(){return Redirect::to("transferypin/create");});
Route::post('transferpin/preview', array('as' => 'transferypin.preview', 'uses' => 'TransferPinController@preview'));
...
Route::get('api/getEasySimName/{msisdn}', array('uses' => 'EasySimReloadAPIController@getEasySimNameByMsisdn'));
...
Route::get('api/getEasySimProduct/{id}', array('uses' => 'EasySimReloadAPIController@getEasySimProductByCategory'));
...
Route::post("/api/address_line_3_clean_up", "UpdateDigiAPIController@address_line_3_clean_up");

Route::post("api/easysim/create_reload", array('uses' => "EasySimReloadAPIController@create_reload"));

Route::get('api/test', function(){ 
		return View::make('test');
});
Route::get('api/test_api', function(){ 
		return View::make('test_api');
});

Route::get('api/test_update_tron_account_user', function(){ 
		return View::make('test_update_tron_account_user');
});

Route::get('api/test_deactivate_tron_account_user', function(){ 
		return View::make('test_deactivate_tron_account_user');
});

Route::get('api/test_update_mno_subscriber_info', function(){ 
		return View::make('test_update_mno_subscriber_info');
});

Route::get('api/cleanup_mno_subscriber_address_3', function(){ 
		return View::make('cleanup_mno_subscriber_address_3');
});

// HDLS Account API, added by Naz
