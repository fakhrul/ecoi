...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div class="ms-options-wrap" style="border-radius:4px;border:1px solid #ccc;"><button><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
